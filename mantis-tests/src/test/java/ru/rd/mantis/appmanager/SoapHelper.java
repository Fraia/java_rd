...
import ru.rd.mantis.model.Project;
...
public class SoapHelper {
    ...
    public Set<Project> getProjects() throws MalformedURLException, ServiceException, RemoteException {
        ...
        ProjectData[] projects = mc.mc_projects_get_user_accessible(app.getProperty("mantis.username"), app.getProperty("mantis.password"));
    ...
    public Issue getIssueById(BigInteger id) throws MalformedURLException, ServiceException, RemoteException {
        MantisConnectPortType mc = getMantisConnect();
        IssueData issueData = mc.mc_issue_get("administrator", "root", id);
        ...
        return new Issue().withId(issueData.getId().intValue()).withSummary(issueData.getSummary())
                ...
                .withProject(new Project().withId(issueData.getProject().getId().intValue())
                        .withName(issueData.getProject().getName())).withStatus(issueData.getStatus());
    }
}
